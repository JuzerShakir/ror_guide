...
4. [RVM](#rvm)
5. [Ruby Docs](#ruby-docs)
   a. [Numeric](#numeric-class)
   b. [String](#string-class)
   c. [Symbol](#symbol-class)
   d. [Regex](#regex)
   e. [Array](#array-class)
   f. [Hash](#hash-class)
   g. [Enumerable](#enumerable-module)
   h. [Enumerator](#enumerator-class)
   i, [Range](#range-class)
   i. [Set](#set-class)
   j. [Time](#time-class)
   k. [Struct](#struct-class)
   l. [Nil](#nil-class)
6. [Gems](#gems)
